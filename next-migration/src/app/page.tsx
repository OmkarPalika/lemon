  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center text-center">
        <h1 className="text-4xl font-bold tracking-tight">AML Core Migration (Phase 4)</h1>
        <p className="text-lg text-muted-foreground max-w-[600px]">
          Welcome to the Next.js migration of the AML Core platform.
          This phase integrates the Branch and Case modules.
        </p>
        <div className="flex gap-4 items-center flex-col sm:flex-row mt-4 flex-wrap justify-center">
          ...
          <Link href="/branches">
            <Button size="lg">Branches</Button>
          </Link>
          <Link href="/cases">
            <Button size="lg">Cases</Button>
          </Link>
        </div>
      </main>
    </div>
